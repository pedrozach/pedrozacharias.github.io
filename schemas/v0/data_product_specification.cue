...
// Union of allowed operators
#AllowedOperators: #SparkOperator | #AWSBatchOperator | #TrinoOperator
...
#Workload: {
  ...
  tags: [... #OM_Tag]
  readsFrom: [... string]
  // 'specific' field detailed
  specific: {
    airflow: {
      dagId:       string
      schedule:    string
      defaultArgs: {...}
      tasks:       [...#AllowedOperators]
    }
  }
} 
